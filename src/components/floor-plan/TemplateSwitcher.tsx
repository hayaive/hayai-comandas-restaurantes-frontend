    ...
    <div className="flex items-center gap-1 overflow-x-auto">
        ...
        return (
          <div key={template.id} className="group relative flex shrink-0 items-center">
            <button
              ...
              className={cn(
                "whitespace-nowrap rounded-[var(--radius-pill)] px-3.5 py-1.5 text-[13px] font-medium transition-colors duration-150",
                active
      ...
      {creating ? (
        <input
          ...
          className="h-[30px] w-40 shrink-0 rounded-[var(--radius-pill)] border border-accent bg-surface px-3.5 text-[13px] text-fg outline-none"
        />
      ) : (
        <button
          type="button"
          ...
          className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-full border border-dashed border-border-strong text-fg-subtle transition-colors duration-150 hover:border-accent hover:text-accent"
        >
